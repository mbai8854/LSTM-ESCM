%% Remark: this program should be run on MATLAB 2019a.
...
%         errorss_test = [];
        ...
        for mmk = 1:2
            ...
            test_err(i,mmld,mmk) = missclass(spectralCC3{i,mmk},N,ngroups)/sum(N)*100;
        end
...
%% Average test error
snp_mean_test_error = mean(test_err, 3);

mean_test_error = squeeze(mean(snp_mean_test_error, 1));
